    ...
    describe '#new_post' do
      describe 'create a new post' do
        ...
        describe '#delete post' do
          it 'can delete a post from the db' do
            VCR.use_cassette('delete_post_service') do
              ...
              @deleted_post = DatabaseService.delete_post(@user_post.id)

              expect(@deleted_post.present?).to eq false
            end
          end
        end
